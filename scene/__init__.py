...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["Multi-scale"](args.source_path, args.white_background, args.eval,
                                                               args.load_allres)
        else:
...
class SocketScene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, loaded_iter=False, load_iteration=None, shuffle=True,
                 resolution_scales=[1.0], host="127.0.0.1", port=12345, duration=3):
        self.model_path = args.model_path
        ...
        scene_info = sceneLoadTypeCallbacks["Multi-scale-Socket"](meta_with_imgs, args.white_background, args.eval,
                                                                  False, ndown)
